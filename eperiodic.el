...
;;; Copyright (C) 2001, 2002, 2003, 2004, 2005, 2008 Matthew P. Hodges

;; Author: Matthew P. Hodges <MPHodges@member.fsf.org>
;; Version: $Id: eperiodic.el,v 1.112 2008/07/12 15:32:13 mphodges-guest Exp $
...
(defgroup eperiodic nil
  ...
  :group 'tools
  :link '(url-link "http://mph-emacs-pkgs.alioth.debian.org/EperiodicEl.html"))

(defcustom eperiodic-display-type 'mendeleev-separate
...
being shown in order."
  :group 'eperiodic
  :type '(choice (const :tag "Mendeleev (Separate f-block)" mendeleev-separate)
                 (const :tag "Mendeleev (Full f-block)" mendeleev-full)
                 (const :tag "Left-Step (Janet)" left-step))
  :set (lambda (sym val)
         (set-default sym val)
...
(defvar eperiodic-colour-element-functions
  (nconc
   '(eperiodic-colour-element-by-group
     eperiodic-colour-element-by-series
...
(defface eperiodic-s-block-face
  '((((class color))
     (:inherit eperiodic-generic-block-face :background "blue" :foreground "white")))
...
(defface eperiodic-1-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "purple"))
...
(defface eperiodic-2-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "Red"))
    (((class color) (min-colors 8))
     (:inherit eperiodic-generic-block-face :background "yellow" :foreground "black")))
...
(defface eperiodic-3-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "Orange"))
    (((class color) (background light) (min-colors 8))
     (:inherit eperiodic-generic-block-face :background "red" :foreground "black"))
    (((class color) (background dark) (min-colors 8))
     (:inherit eperiodic-generic-block-face :background "red" :foreground "white")))
  "Eperiodic face for 3 elements.")

(defface eperiodic-4-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "Yellow"))
    (((class color) (background light) (min-colors 8))
     (:inherit eperiodic-generic-block-face :background "green" :foreground "black"))
    (((class color) (background dark) (min-colors 8))
     (:inherit eperiodic-generic-block-face :background "green" :foreground "black")))
...
(defface eperiodic-5-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "thistle"))
    (((class color) (min-colors 8))
     (:inherit eperiodic-generic-block-face :foreground "blue" :background "white")))
  "Eperiodic face for 5 elements.")

(defface eperiodic-6-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "CadetBlue3"))
    (((class color) (min-colors 8))
...
(defface eperiodic-7-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "PaleGreen1"))
    (((class color) (background light) (min-colors 8))
...
(defface eperiodic-8-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "Gray"))
    (((class color) (background light) (min-colors 8))
     (:inherit eperiodic-generic-block-face :foreground "green" :background "black"))
    (((class color) (background dark) (min-colors 8))
     (:inherit eperiodic-generic-block-face :foreground "green" :background "black")))
  "Eperiodic face for 8 elements.")

(defface eperiodic-9-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "goldenrod1"))
    (((class color) (min-colors 8))
     (:inherit eperiodic-generic-block-face :foreground "blue" :background "yellow")))
  "Eperiodic face for 1 elements.")

(defface eperiodic-10-face
  '((((class color) (min-colors 88))
     (:inherit eperiodic-generic-block-face :background "light coral"))
    (((class color) (min-colors 8))
     (:inherit eperiodic-generic-block-face :foreground "white" :background "black")))
  "Eperiodic face for 1 elements.")

(defface eperiodic-actinide-face
  '((t
     (:inherit eperiodic-1-face)))
  "Eperiodic face for actinide elements."
  :group 'eperiodic)

(defface eperiodic-alkali-metal-face
  '((t
     (:inherit eperiodic-2-face)))
  "Eperiodic face for alkali metal elements."
  :group 'eperiodic)

(defface eperiodic-alkaline-earth-metal-face
  '((t
     (:inherit eperiodic-3-face)))
  "Eperiodic face for alkaline earth metal elements."
  :group 'eperiodic)

(defface eperiodic-halogen-face
  '((t
     (:inherit eperiodic-4-face)))
  "Eperiodic face for halogen elements."
  :group 'eperiodic)

(defface eperiodic-lanthanide-face
  '((t
     (:inherit eperiodic-5-face)))
  "Eperiodic face for lanthanide elements."
  :group 'eperiodic)

(defface eperiodic-noble-gas-face
  '((t
     (:inherit eperiodic-6-face)))
  "Eperiodic face for noble gas elements."
  :group 'eperiodic)

(defface eperiodic-nonmetal-face
  '((t
     (:inherit eperiodic-7-face)))
  "Eperiodic face for nonmetal elements."
  :group 'eperiodic)

(defface eperiodic-post-transition-metal-face
  '((t
     (:inherit eperiodic-8-face)))
  "Eperiodic face for post-transition metal elements."
  :group 'eperiodic)

(defface eperiodic-semimetal-face
  '((t
     (:inherit eperiodic-9-face)))
  "Eperiodic face for semimetal elements."
  :group 'eperiodic)

(defface eperiodic-transition-metal-face
  '((t
     (:inherit eperiodic-10-face)))
  "Eperiodic face for transition metal elements."
  :group 'eperiodic)
...
(defface eperiodic-superscript-face
  '((t (:height 0.5)))
  "Eperiodic face for superscripts."
  :group 'eperiodic)
...
(defconst eperiodic-display-block-orders
  '((mendeleev-separate (s d p))
    (mendeleev-full (s f d p))
    (left-step (f d p s)))
  ...
  (let ((order eperiodic-orbital-order)
    ...
    (while order
      ...
      (loop for i from z to (+ z degeneracy -1) by 1
            do
            (setq label (concat so-far (if (> (length so-far) 0) " " "") orbital
                                (propertize (format "%d" (1+ (- i z)))
                                            'face 'eperiodic-superscript-face
                                            'display '(raise 0.5))
                                ))
            (setq result
...
(defvar eperiodic-aufbau-exceptions
  (let ((list
    ...
    (setq list (mapcar (lambda (elt)
			     ...
			     (insert (propertize (match-string 1)
                                                        'face 'eperiodic-superscript-face
                                                        'display '(raise 0.5)))
			     (replace-match "" nil nil))
                           (cons (car elt) (buffer-string))))
                       list)))
...
(defconst eperiodic-element-properties
  '((1
    ...
    (17
     ...
     (named-after . "Greek: khlôros (greenish yellow).")
     (series . "halogen"))
    (18
     (name . "Argon")
     (symbol . "Ar")
    ...
    (35
     ...
     (named-after . "Greek: brómos (stench).")
     (series . "halogen"))
    (36
     (name . "Krypton")
     (symbol . "Kr")
    ...
    (53
     ...
     (named-after . "Greek: iodes (violet colored).")
     (series . "halogen"))
    (54
     (name . "Xenon")
     (symbol . "Xe")
    ...
    (58
     ...
     (discovered-by . "Wilhelm Hisinger, Jöns Jakob Berzelius, Martin Heinrich Klaproth")
    ...
    (111
     ...
     (discovery-date . "1994 (Germany)")
     (discovered-by . "GSI (Gesellschaft für Schwerionenforschung mbH, Darmstadt, Germany)")
     (named-after . "Named in honour of German physicist Wilhelm Conrad Röntgen.")
     (series . "transition-metal"))
    (112
     (name . "Ununbium")
     (symbol . "Uub")
  ...
  (let ((display-width (max eperiodic-element-display-width 3))
    ...
    (while order
      ...
      (let ((orbital-list (car order))
        ...
        ;; Period number (look for s orbitals)
        (setq period (car (delq nil
                                (mapcar
                                 (lambda (elt)
                                   (when (string-match "\\([1-9]\\)s" (symbol-name elt))
                                     (match-string 1 (symbol-name elt))))
                                 orbital-list))))
        (if (and period
    ...
    (mapcar (lambda (property)
              (insert
               (format " %-25s %-25s %-s\n"
                       ...
                       (if (eq property 'series)
                           (let ((name (eperiodic-get-element-property z property)))
                             (eperiodic-replace-regexp-in-string "-" " " name))
...
(defun eperiodic-choose-element ()
  "Interactively choose an element; return the atomic number
The choice can be made by element name, symbol, or atomic
number."
  (let ((completion-ignore-case t)
    ...
    (cdr (assoc (capitalize res) eperiodic-completion-table))))
...
The element name, symbol, or atomic number can be used."
  ...
  (let (z)
    (setq z (eperiodic-choose-element))
    (when z
      (goto-char
...
(defun eperiodic-get-element-property (z prop)
  ...
  (cond ((equal prop 'electronic-configuration)
         (let ((exception
           ...
           (if exception
               (concat exception (format " (Aufbau: %s)" (cdr (assoc z eperiodic-elec-configs))))
...
If there is no element at point, choose one interactively.

See also `eperiodic-dict-program' and
`eperiodic-dict-dictionary'."
  (interactive)
  (let ((element (eperiodic-get-element-property
                  (or (eperiodic-element-at) (eperiodic-choose-element)) 'name)))
    (catch 'no-element
      (cond
       ((not element)
        (message "No element chosen")
        (throw 'no-element nil))
...
If there is no element at point, choose one interactively."
  (interactive)
  (let ((z (or (eperiodic-element-at) (eperiodic-choose-element)))
    ...
    (when prop
      ...
      (setq list
            (mapcar (lambda (elt)
                      ...
                      (and (eq prop 'series)
                           (setq value (eperiodic-replace-regexp-in-string "-" " " value)))
                      (setq string (format "%-15s [Z = %3d] -> %s" name z value))
                      (if arg
                          (cons
      ...
      (cond
       ...
       (arg
        (setq list (sort list (lambda (a b)
                                      (<= (car a) (car b)))))))
      ;; Would use with-output-to-temp-buffer here, but want to
      ;; preserve text properties
      (save-excursion
        (set-buffer (get-buffer-create "*Eperiodic element properties*"))
        (let ((inhibit-read-only t))
          (erase-buffer)
          (insert (format "%s" (eperiodic-format-symbol prop)))
          (if (setq unit (cdr (assoc prop eperiodic-stored-properties)))
              (insert (format " (%s):\n\n" unit))
            (insert ":\n\n"))
          (insert (mapconcat (if arg #'cdr #'identity) list "\n"))
          (insert "\n"))
        (set-buffer-modified-p nil)
        (setq buffer-read-only t)
        (goto-char (point-min))
...
(defun eperiodic-jump-to-properties-and-back ()
  "Move point between last selected element and properties.
If we are an element move to the properties, otherwise move to
the last selected element."
  (interactive)
  (if (eperiodic-element-at)
      (progn
...
(defun eperiodic-colour-element-by-series (arg)
  "Colour elements by their series.
Return face for element with atomic number ARG, unless ARG equals the
symbol 'key', in which case insert key elements."
  (cond
   ((eq arg 'key)
    (insert " Series\n")
    (eperiodic-insert-key-elements '(eperiodic-nonmetal-face
                                     eperiodic-noble-gas-face
                                     eperiodic-alkali-metal-face
                                     eperiodic-alkaline-earth-metal-face
                                     eperiodic-semimetal-face
                                     eperiodic-halogen-face
                                     nil
                                     eperiodic-post-transition-metal-face
                                     eperiodic-transition-metal-face
                                     eperiodic-lanthanide-face
                                     eperiodic-actinide-face
                                     eperiodic-unknown-face)))
   (t
    (intern (format "eperiodic-%s-face"
        (eperiodic-get-element-property arg 'series))))))
...
See `eperiodic-display-lists'."
  (interactive)
  (let ((completion-ignore-case t)
        (table '(("Mendeleev (Separate f-block)" . mendeleev-separate)
                 ("Mendeleev (Full f-block)" . mendeleev-full)
                 ("Left-Step (Janet)" . left-step)))
        choice)
    (setq choice
          (cdr (assoc
...
(defvar eperiodic-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "j")   'eperiodic-jump-to-properties-and-back)
